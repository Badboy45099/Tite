...
-- ============================================================================
-- AIMBOT.LUA (Hosted Script - Full Aggressive Destroyer)
-- ============================================================================
...
local function CleanOldElements()
    -- 1. Disconnect all event connections instantly
    ...
    -- 2. Clean out UI Elements from CoreGui and PlayerGui
    local CoreGui = game:GetService("CoreGui")
    local LocalPlayer = game:GetService("Players").LocalPlayer
    local PlayerGui = LocalPlayer and LocalPlayer:FindFirstChild("PlayerGui")
    
    -- Destroy our custom toggle button
    ...
    -- 3. FORCED DESTRUCTION of the third-party script's UI elements
    -- Scans for common UI names created by external scripts to wipe them out
    local function WipeExternalGuis(parent)
        if not parent then return end
        for _, child in ipairs(parent:GetChildren()) do
            -- Looks for keywords usually generated by custom scripts or UI libs
            if child:IsA("ScreenGui") and (child.Name:find("Aimbot") or child.Name:find("Fluent") or child.Name:find("Linoria") or child.Name:find("Library")) then
                pcall(function() child:Destroy() end)
            end
        end
    end

    WipeExternalGuis(CoreGui)
    WipeExternalGuis(PlayerGui)
end
...
local function UnloadAimbotScript()
    ...
    SendNotification("Aimbot Unloaded", "All elements destroyed completely.", 2)
end
...
task.spawn(function()
    ...
    -- Keep looping as long as the main toggle is ON
    while _G.AimbotActive do
        task.wait(0.2)
    end
    
    -- Triggered immediately when _G.AimbotActive becomes false
    UnloadAimbotScript()
end)
